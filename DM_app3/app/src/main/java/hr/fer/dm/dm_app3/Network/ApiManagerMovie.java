 ...
 */
public class ApiManagerMovie {

    private static final String TAG = "Network";

    public static final String API_ENDPOINT = "http://dm-api.mediatoolkit.com";
    ...
    private static final MovieApiService MOVIE_SERVICE = REST_ADAPTER.create(MovieApiService.class);
